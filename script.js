...
const iconPaused = document.querySelector('.app__card-primary-butto-icon');
...
function iniciarOuPausar() {
    ...
    iconPaused.setAttribute('src', '/imagens/pause.png');
    iniciarOuPausarBt.textContent = "Pausar"
}

function zerar() {
    clearInterval(intervaloId);
    iconPaused.setAttribute('src', '/imagens/play_arrow.png');
